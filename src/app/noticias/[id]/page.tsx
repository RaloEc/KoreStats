...
export async function generateStaticParams() {
  ...
  try {
    ...
    if (error) {
      console.error("[generateStaticParams] Error fetching noticias:", error);
      return [];
    }
...
export default async function NoticiaDetalle({
  ...
  try {
    ...
    try {
      ...
      console.error("[NoticiaDetalle] Error verificando auth:", authError);
      // Continuar sin auth, el usuario no será admin
    }
    ...
    console.error("[NoticiaDetalle] Error crítico:", error);
    notFound();
  }
}
