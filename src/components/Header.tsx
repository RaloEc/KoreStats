...
const Header: React.FC = () => {
  ...
  return (
    <>
      ...
      <div
        role="banner"
        className="lg:block hide-on-mobile-pwa relative z-50 border-b border-gray-200/50 dark:border-gray-800/50 bg-white dark:bg-black text-gray-900 dark:text-white shadow-sm w-full"
      >
