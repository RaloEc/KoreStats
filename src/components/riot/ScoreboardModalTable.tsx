        ...
        <div className="flex flex-col items-center gap-1 ml-1">
          ...
          <button
            ...
            className={`inline-flex items-center justify-center p-1 rounded-md border transition-colors ${
              isSaved
                ...
                : "border-slate-200 bg-white/80 text-slate-400 hover:text-slate-700 hover:bg-slate-50 dark:border-slate-700 dark:bg-slate-900/30 dark:text-slate-500 dark:hover:text-slate-300 dark:hover:bg-slate-800/40"
          ...
          {canSave && (
            <PlayerNoteButton
              ...
              gameName={player.riotIdGameName || player.summoner_name}
              ...
              onSave={(data) =>
                saveNote({
                  ...
                  target_game_name:
                    player.riotIdGameName || player.summoner_name,
                  target_tag_line: player.riotIdTagLine,
                  ...data,
                })
              }
