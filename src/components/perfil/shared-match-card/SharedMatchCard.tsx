...
export const SharedMatchCardRefactored: React.FC<SharedMatchCardProps> = memo(
  ({
    ...
    const hasComparative =
      Boolean(partida.teamTotalDamage && partida.teamTotalDamage > 0) ||
      Boolean(partida.teamTotalGold && partida.teamTotalGold > 0) ||
      Boolean(
        partida.teamAvgDamageToChampions &&
        partida.teamAvgDamageToChampions > 0,
      ) ||
      Boolean(partida.teamAvgGoldEarned && partida.teamAvgGoldEarned > 0);
    const hasTeams = Boolean(
      partida.allPlayers && partida.allPlayers.length > 0,
    );
    const mobileCarouselPages = 1 + (hasTeams ? 1 : 0);
    ...
    const rankingBadgeClass =
      partida.rankingPosition && partida.rankingPosition <= 3
        ? "border-white/40 bg-black/40 text-white shadow-[0_10px_30px_rgba(0,0,0,0.4)] backdrop-blur-md before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/50 before:to-transparent after:content-[''] after:absolute after:top-0 after:left-0 after:w-px after:h-full after:bg-gradient-to-b after:from-white/50 after:via-transparent after:to-white/20"
        : "border-white/20 bg-black/30 text-white/90 shadow-[0_6px_20px_rgba(0,0,0,0.3)] backdrop-blur-md before:content-[''] before:absolute before:top-0 before:left-0 before:right-0 before:h-px before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent after:content-[''] after:absolute after:top-0 after:left-0 after:w-px after:h-full after:bg-gradient-to-b after:from-white/30 after:via-transparent after:to-white/10";
    ...
    // Ordenamos para que queden Runas a la izquierda y Hechizos a la derecha
    const runesComponent = (
      <div className="grid grid-cols-2 grid-rows-2 gap-0.5 w-10 h-10">
        {/* Celda 1,1: Runa Primaria */}
        <MatchRunes
          mode="primary"
          ...
          <div className="relative min-h-[22rem] rounded-lg overflow-hidden">
            ...
            <div className="absolute inset-0 overflow-hidden">
              ...
              <div
                className={`absolute inset-0 ${
                  isWin
                    ? "bg-gradient-to-b from-black/60 via-transparent to-emerald-50/80 dark:from-black/80 dark:via-black/20 dark:to-emerald-950/90"
                    : "bg-gradient-to-b from-black/60 via-transparent to-rose-50/80 dark:from-black/80 dark:via-black/20 dark:to-rose-950/90"
                }`}
              />
            ...
            <div className="relative z-10 flex flex-col gap-4 p-4 sm:p-6 text-slate-950 dark:text-white">
              ...
              <MatchHeader
                ...
                riotIdGameName={partida.riotIdGameName}
                riotIdTagline={partida.riotIdTagline}
                sharedBy={sharedBy}
              ...
              {!isDetailsOpen && (
                <div className="flex flex-col items-center justify-center py-2 -mt-2 animate-in fade-in zoom-in duration-300">
                  ...
                  <div className="bg-white/70 dark:bg-black/40 backdrop-blur-md rounded-xl px-4 py-3 border border-slate-200/50 dark:border-white/10 shadow-lg">
                    ...
                    <div className="flex items-center gap-2 justify-center border-t border-slate-200/50 dark:border-white/5 pt-1 mt-1">
                      <span
              ...
              >
                ...
                <div className="sm:hidden">
                  <div className="relative">
                    ...
                    >
                      <div className="snap-center w-[88%] shrink-0 flex flex-col gap-4">
                        <MatchStats
                          kills={partida.kills}
                          deaths={partida.deaths}
                          assists={partida.assists}
